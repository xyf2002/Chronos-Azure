...
echo "GRUB_DEFAULT='gnulinux-advanced-3802fcbd-b1f5-4119-b2eb-258d1eeceb4c>gnulinux-5.15.160+-advanced-3802fcbd-b1f5-4119-b2eb-258d1eeceb4c'" | sudo tee -a /etc/default/grub.d/50-cloudimg-settings.cfg
sudo update-grub
